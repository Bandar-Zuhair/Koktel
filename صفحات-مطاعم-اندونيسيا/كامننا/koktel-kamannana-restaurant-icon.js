...
if (localStorage.getItem('Kamannana_LocalStorage')) {
    ...
    let koktel_mealOrderIcon = `<a href='https://bandar-zuhair.github.io/Koktel/صفحات-مطاعم-اندونيسيا/كامننا/طلباتك-من-مطعم-كامننا.html' id="koktel_order_page_icon"><ion-icon name="cart-outline"></ion-icon></a>`;
