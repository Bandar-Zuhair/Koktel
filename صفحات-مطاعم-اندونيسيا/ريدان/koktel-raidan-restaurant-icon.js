...
if (localStorage.getItem('Raidan_LocalStorage')) {
    ...
    let koktel_mealOrderIcon = `<a href='https://bandar-zuhair.github.io/Koktel/صفحات-مطاعم-اندونيسيا/ريدان/طلباتك-من-مطعم-ريدان.html' id="koktel_order_page_icon"><ion-icon name="cart-outline"></ion-icon></a>`;
