...
if (localStorage.getItem('Koktel_LocalStorage')) {
    ...
    let koktel_mealOrderIcon = `<a href='https://bandar-zuhair.github.io/Koktel/صفحات-مطاعم-اندونيسيا/كوكتيل/طلباتك-من-مطعم-كوكتيل.html' id="koktel_order_page_icon"><ion-icon name="cart-outline"></ion-icon></a>`;
