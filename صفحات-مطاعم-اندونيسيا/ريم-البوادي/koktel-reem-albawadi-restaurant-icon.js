...
if (localStorage.getItem('Reem_Albawadi_LocalStorage')) {
    ...
    let koktel_mealOrderIcon = `<a href='https://bandar-zuhair.github.io/Koktel/صفحات-مطاعم-اندونيسيا/ريم-البوادي/طلباتك-من-مطعم-ريم-البوادي.html' id="koktel_order_page_icon"><ion-icon name="cart-outline"></ion-icon></a>`;
